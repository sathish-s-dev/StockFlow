...
const Home = () => {
  ...
  return (
    <main className="flex flex-col gap-4">
      ...
      <div className="max-w-xl bg-white rounded-md p-2">
        <ApexChart />
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 ">
        {stocks.map((stock) => (
          ...
          >
            ...
            <div className="mt-4">
              <p className="text-sm text-pretty line-clamp-2 text-gray-500">
...
function TopNavbar() {
  return <div className="bg-emerald-400 mt-4 p-2 rounded-md">TopNavbar</div>;
}
